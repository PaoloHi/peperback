...
const primerTabla_ = document.querySelectorAll('.primerTabla')
const segundaTabla_ = document.querySelectorAll('.segundaTabla')
const tercerTabla_ = document.querySelectorAll('.tercerTabla')

/*botones para cambiar la vista*/
opcion1 = document.getElementById('btnOnboarding')
opcion2 = document.getElementById('btnVenta')
opcion3 = document.getElementById('btnEntrega')
...
const etiquetas = [primerTabla_, segundaTabla_, tercerTabla_]
...
function makePaginationFooter(paginaNum, allCards) {
    ...
    // Agregar flecha izquierda solo si no estamos en la primera página y hay más de 4 páginas
    ...
    // Agregar flecha derecha solo si no estamos en la última página y hay más de 4 páginas
